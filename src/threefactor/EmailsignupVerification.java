 ...
 * @author Deepak
 */
public class EmailsignupVerification extends javax.swing.JFrame {
   ...
   public Statement st;
    ...
    public EmailsignupVerification() {
        initComponents();
...
try{
    String mailid= "Select * from fakemydb where online='1'";
    String Otp="Update fakemydb set OTP='"+otp+"' where online='1'";
    st.addBatch(Otp);
    st.executeBatch();
...
final String username = "thrfctr@gmail.com";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmailsignupVerification.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
